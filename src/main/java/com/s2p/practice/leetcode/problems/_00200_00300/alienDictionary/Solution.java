package com.s2p.practice.leetcode.problems._00200_00300.alienDictionary;
...
//        System.out.println(new Solution().alienOrder(new String[]{"z","z","z"}));
//        System.out.println(new Solution().alienOrder(new String[]{"zy","zx"}));
